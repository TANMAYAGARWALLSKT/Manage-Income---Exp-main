...
function Vendor() {
  ...
  const handleFetchVendors = async () => {
    ...
    try {
      ...
      const querySnapshot = await getDocs(query(vendorCollection));
              ...
              >
                ...
                <div className="flex gap-3 p-4">
                  <button
                    ...
                    className="flex-1 bg-blue-500 hover:bg-blue-600 py-2.5 rounded-lg font-medium transition-all duration-200 text-white"
                  >
                    Update Details
                  </button>
                  <button
                    ...
                    className="flex-1 bg-indigo-500 hover:bg-indigo-600 py-2.5 rounded-lg font-medium transition-all duration-200 text-white"
                  >
                    View History
                  </button>
                </div>
